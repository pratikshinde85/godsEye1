...
public class DashboardController implements Initializable {
    ...
    public void save_img(){
            ...
            //Directory 
            fileChooser.setInitialDirectory(new File("C:\\Users\\rutik\\Documents\\NetBeansProjects\\Project Code (forensic face sketch)\\GodsEye v2\\src\\godseye\\v2\\elements\\output"));
           ...
           // save_img(); //Save image
            ...
            // open the upload the sketch page
                try {
                    ...
                    fxmlLoader.setLocation(getClass().getResource("C:\\Users\\rutik\\Documents\\NetBeansProjects\\Project Code (forensic face sketch)\\godsEye_FaceMatch\\src\\main\\java\\com\\mycompany\\thirdeye_facematch"));
...
//     private void onCompare(MouseEvent event) {
//    try {
//        // Path to the other Java project's main class
//        String projectPath = "C:\\Users\\rutik\\Documents\\NetBeansProjects\\Project Code (forensic face sketch)\\godsEye_FaceMatch\\face_rekognition.";
//        String mainClass = "com.mycompany.thirdeye_facematch";
//
//        // Construct the command to run the other Java application
...
//    } catch (IOException e) {
//        Logger logger = Logger.getLogger(getClass().getName());
//        logger.log(Level.SEVERE, "Failed to open new project", e);
//    }
//}
